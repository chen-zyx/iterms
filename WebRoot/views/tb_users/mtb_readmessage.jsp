...
<script type="text/javascript">
	...
	function rst(currentPage){
			window.location.href="<%=basePath%>tb_message/tb_message_read?currentPage="+currentPage;
	}
	//回复
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-warning" onclick="send('${messages.currentPage}')">发送</button>
